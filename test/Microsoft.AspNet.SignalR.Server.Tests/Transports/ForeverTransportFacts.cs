...
namespace Microsoft.AspNet.SignalR.Server.Tests.Transports
{
    public class ForeverTransportFacts
    {
        ...
        public void SendUrlTriggersReceivedEvent()
        {
            ...
            loggerFactory.Setup(m => m.Create("foo")).Returns(logger.Object);

            var transport = new Mock<ForeverTransport>(hostContext, json, heartBeat.Object, counters.Object, loggerFactory.Object)
            {
                CallBase = true
            };
        ...
        public void ReceiveThrowingReturnsFaultedTask()
        {
            ...
            var qs = new Mock<IReadableStringCollection>();
            qs.Setup(m => m["connectionId"]).Returns("1");
        ...
        public void RequestCompletesAfterFaultedInitializeResponse()
        {
            ...
            var transport = new Mock<ForeverTransport>(hostContext, json, heartBeat.Object, counters, loggerFactory.Object)
            {
                CallBase = true
            };
